...
//                   nullArtworkWidget:  const Icon(Icons.music_note,size: 48,color: AppColors.whiteColor,),
//                 ),
//
//               ),
//             ),
...
//                child: Obx(() => Column(
//                  children: [
//                    Text(data[playController.playIndex.value].displayNameWOExt,
...
//                      height: 12,
//                    ),
//                    Text(data[playController.playIndex.value].artist.toString(),
//                      textAlign: TextAlign.center,
//                      overflow: TextOverflow.ellipsis,
//                      maxLines: 2,
//                      style: CustomTextTheme.textOne.copyWith(
...
//                          style: CustomTextTheme.textOne!.copyWith(color: AppColors.bgColor,fontSize: 10),),
//                        Expanded(
//                          child: Slider(
...
//                        IconButton(
//                          onPressed: (){
//                            playController.playSong(data[playController.playIndex.value-1].uri, playController.playIndex.value-1);
//                          },
//                          icon: const Icon(
...
//                                  }
//                                },
//                                icon: playController.isPlaying.value ? const Icon(
//                                  Icons.pause,
//                                  size: 54,
//                                  color: AppColors.whiteColor,
//                                ):
